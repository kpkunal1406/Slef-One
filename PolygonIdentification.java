...
public class PolygonIdentification {
	 ...
	 *            space-separated integers, which represent the length of the
	 *            sides of the polygon
	 * @return a single line which contains 3 space-separated integers;
	 *         representing the number of squares, number of rectangles, and
	 *         number of other polygons with 4 sides.
	 */
	...
	/**
	 * If all the sides of the polygon are either negative or positive numbers,
	 * then consider as a valid polygon. Otherwise, consider as a invalid
	 * polygon (if one of the four integers is a negative number)
	 * 
	 * @param line
