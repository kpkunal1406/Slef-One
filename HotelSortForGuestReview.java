...
public class HotelSortForGuestReview {
	...
	public static void main(String args[]) throws Exception {
		...
		String[][] reviews = new String[noOfReviews][2];

		for (int i = 0; i < noOfReviews; i++) {
			reviews[i][0] = sc.nextLine();
			reviews[i][1] = sc.nextLine();
		}
		System.out.println(hotels(words, reviews));
	}

	/**
	 * 
	 * @param words
	 *            space-separated set of words which you want to find mentions
	 *            in the hotel reviews
	 * @param reviews
	 *            2D array which contains hotelIds and guest reviews belong to
	 *            each hotel. First column represents hotelIds and second column
	 *            represents respective review
	 * @return a list of hotelIds sorted, in descending order, by how many
	 *         mentions they have of the words specified in the reviews
	 */
	...
	/**
	 * Sort the map and get hotelIds in descending order, by how many mentions
